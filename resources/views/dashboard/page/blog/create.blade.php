                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('blog.index')}}">{{__('site.works')}}</a>
                                </li>
                                <li class="breadcrumb-item active">ا{{__('site.add')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <form action="{{route('blog.store')}}" method="post" enctype="multipart/form-data"
                                    ...
                                    @foreach(config('translatable.locales') as $locale)
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="{{$locale}}[title]" class="form-control"
                                    ...
                                    @foreach(config('translatable.locales') as $locale)
                                        <div class="form-group">
                                            ...
                                            <textarea required type="text" name="{{$locale}}[description]"
