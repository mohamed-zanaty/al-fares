                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">  {{__('site.categories')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">  {{__('site.categories')}} </h4>
                                                            ...
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                @if (auth('admin')->user()->hasPermission('categories_update'))
                                                                    ...
                                                                    <a href="{{route('category.edit',$category -> id)}}"
                                                                       class="btn btn-outline-primary btn-sm box-shadow-3 mr-1 mb-1">  {{__('site.edit')}}</a>
                                                                @else
                                                                    <a href="#"
